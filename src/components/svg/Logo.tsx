...
/**
 * ロゴのSVGコンポーネント
 * @param width - 幅（デフォルト32px）
 * @param height - 高さ（デフォルト32px）
 * @param className - 追加のCSSクラス
 * @param color - 円の色（デフォルト#4CB3F8）
 */
